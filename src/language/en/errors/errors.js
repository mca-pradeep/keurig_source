...
export const HANDLE_OPEN_MESSAGE_001 = 'Please close handle and insert a new pod to continue brewing.';

export const OTHER_THAN_BREWING_001 = 'Please close handle.';

export const POD_BIN_FULL_MSG_001 = 'Pod bin is full. Please empty.';
export const POD_BIN_FULL_MSG_001 = 'Please reinsert pod bin.';